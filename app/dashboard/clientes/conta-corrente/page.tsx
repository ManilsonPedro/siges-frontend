  ...
  C001: {
    ...
    lancamentos: [
      ...
      },
      {
        ...
        descricao: "Venda Multiuso 5L × 240",
        debito: 960_000,
        credito: 0,
        saldo: 960_000,
      },
    ...
    lancamentos: [
      {
        ...
        descricao: "Venda Multiuso 5L × 600",
        debito: 1_800_000,
        credito: 0,
        saldo: 1_800_000,
      },
      ...
      },
      {
        ...
        descricao: "Venda Multiuso 1L × 2400",
        debito: 2_640_000,
        credito: 0,
        saldo: 2_640_000,
      },
      ...
      },
      {
        ...
        descricao: "Venda Multiuso 5L × 900",
        debito: 2_700_000,
        credito: 0,
        saldo: 3_840_000,
      },
      ...
      },
      {
        ...
        descricao: "Venda Multiuso 5L × 720",
        debito: 2_160_000,
        credito: 0,
        saldo: 2_160_000,
      },
      ...
      },
      {
        ...
        descricao: "Venda Multiuso 1L × 3000",
        debito: 3_300_000,
        credito: 0,
        saldo: 3_300_000,
      },
    ...
    lancamentos: [
      {
        ...
        descricao: "Venda Multiuso 1L × 1200",
        debito: 1_320_000,
        credito: 0,
        saldo: 1_320_000,
      },
      ...
      },
      {
        ...
        descricao: "Venda Multiuso 1L × 1800",
        debito: 1_980_000,
        credito: 0,
        saldo: 1_980_000,
      },
      ...
      },
      {
        ...
        descricao: "Venda Multiuso 1L × 2400 + 5L × 120",
        debito: 2_640_000,
        credito: 0,
        saldo: 3_620_000,
      },
...
export default function ContaCorrentePage() {
  ...
  return (
    <div className="space-y-6 p-6">
      {/* Aviso: dados de demonstração até o endpoint real ser ligado (ver PROMPT_SISTEMA_SIGES_SPRINTS.md, Sprint 1.3) */}
      <div className="flex items-center gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 dark:border-amber-800 dark:bg-amber-950/40">
        <Database className="h-5 w-5 shrink-0 text-amber-600 dark:text-amber-400" />
      ...
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-ink-mid/70 dark:text-ink-mid/60">
            Extrato de movimentos por cliente · 2026
          </p>
        </div>
      </div>
